...
class UListAsync
{
     ...
     */
    countColleDocs(colleName, query, options)
    {
        // return this.toPromise(
        //     function(_this, resolve)
        //     {
        ...
        return this.toPromise(
            function(_this, resolve)
            {
                _this.ul.countColleDocs(colleName, query, options, resolve);
            }
        );
    }
     ...
     * @param {Object} result The result of counting the documents in the colleciton.
     */
    countColle(colleName, query, options)
    {
        return this.toPromise(
            function(_this, resolve)
            {
                _this.ul.countColle(colleName, query, options, resolve);
            }
        );
    }
     ...
     * @returns {Promise} The `Promise` object of processing the relative statement.\
     * NOTE: The `resolve()` method of `Promise` object returns:
     * @param {Object} result The result of closing.
     */
    closeClient()
    {
        return this.toPromise(
